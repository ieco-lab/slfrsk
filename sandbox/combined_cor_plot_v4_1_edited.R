...
pdf(paste0("./submission/Global_MAXENT/figures/legend_combined_v",vers,".pdf"), width = 3, height = 8)
grid.draw(legend)
dev.off()
...
if(FALSE){
  pdf("./submission/Global_MAXENT/figures/state_legend_combined_v2_5.pdf", width = 3, height = 8)
  grid.draw(legend_state)
  dev.off()

  pdf("./submission/Global_MAXENT/figures/country_legend_combined_v2_5.pdf", width = 3, height = 8)
