...
states_summary_future <- states_summary_future %>%
  mutate(grand_mean_max = signif(grand_mean_max, digits = 5),
         ...
         avg_infected_trade = signif(avg_infected_trade, digits = 5),
         se_trade = signif(se_trade, digits = 5),
         avg_infected_mass = signif(avg_infected_mass, digits = 5),
         se_mass = signif(se_mass, digits = 5),
