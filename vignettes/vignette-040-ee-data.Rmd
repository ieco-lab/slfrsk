...
![Landing page and labeled visualization tools for `slfrsk` EE App.](../docs/articles/vignette-040-ee-data_files/figure-html/slfrsk_ee_home_label.png)
...
![Default view of Layers Panel for `slfrsk` EE App.](../docs/articles/ee_figures/slfrsk_ee_layers_panel.png)
