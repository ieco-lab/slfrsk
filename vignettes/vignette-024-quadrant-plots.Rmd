...
if (statez) {
  if(present_transport){
    pdf(file.path(here::here(),"vignettes", paste0("states_combined_present_max_",impact_prod,"_v3.pdf")),width = 7.5, height = 7)

} else{
    pdf(file.path(here::here(),"vignettes", paste0("states_combined_future_max_",impact_prod,"_v3.pdf")),width = 7.5, height = 7)
...
if(present_transport){
    pdf(file.path(here::here(),"vignettes", paste0("countries_combined_present_max_",impact_prod,"_v3.pdf")),width = 7.5, height = 7)

} else{
    pdf(file.path(here::here(),"vignettes", paste0("countries_combined_future_max_",impact_prod,"_v3.pdf")),width = 7.5, height = 7)
...
#countries_grob2 <- countries_grob
#countries_grob2$layout[countries_grob2$layout$name == "panel", "clip"] <- "on"
#countries_grob2$layout[countries_grob2$layout$name == "spacer", "clip"] <- "on"


if(present_transport){
    pdf(file.path(here::here(),"vignettes", paste0("combined_present_max_",impact_prod,"_v3.pdf")),width = 10, height = 12)

} else{
    pdf(file.path(here::here(),"vignettes", paste0("combined_future_max_",impact_prod,"_v3.pdf")),width = 10, height = 12)
      
}
  grid.arrange(states_grob, countries_grob, legend_country, nrow = 7, ncol = 6, layout_matrix = lay, heights = c(2,2,2, 0, 2,2,2), widths = c(1,1,1,0,0.38,0.38))
  invisible(dev.off())
