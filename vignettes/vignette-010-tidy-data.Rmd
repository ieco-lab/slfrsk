...
This section provides the code to save each of the final summary objects to the `/data` directory. They are currently commented out, as the package **should** ship with the files already in `/data`.
