...
~~1. make arrows plot to the capitals of countries for coordinates rather than the centroids (change the x and y values in `countries_trade_final`) (do it manually)~~
