...
Here is the first of the code adapted from Seba De Bona (SDB), who built the `lycordata` and `lycormap` packages. This code finds the county that  each presence point corresponds to and attaches the county shapefile data to those rows.
...
pdf(file.path(here::here(),"vignettes", paste0("spread_figure.pdf")),width = 10, height = 8)
map_plot
invisible(dev.off())
