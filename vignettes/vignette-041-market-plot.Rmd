...
layout(xaxis = 
         ...
         title = 
           list(text = paste('Spotted Lanternfly Paninvasion Risk Severity =', shock_cor,'of 10 (P<0.001)'),
                font = list(size = 12),
                x = 0.1,
                y = 0.99),
         showlegend = F
...
```{r, save pdf of image, message=TRUE, eval=FALSE}
if(FALSE){
  pdf(file.path(here::here(),
              "vignettes", 
              paste0("market_scatter_v4_0.pdf")),
