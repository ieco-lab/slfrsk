...
layout(xaxis = 
         ...
         title = 
           list(text = paste('Spotted Lanternfly Paninvasion Risk Severity =', shock_cor,'of 10 (P<0.005)'),
                font = list(size = 12),
                x = 0.1,
                y = 0.99),
         showlegend = F
...
```{r, save pdf of image, message=TRUE, eval=FAKSE}
if(FALSE){
  pdf(file.path(here::here(),
              "vignettes", 
              paste0("market_scatter_v3_2.pdf")),
