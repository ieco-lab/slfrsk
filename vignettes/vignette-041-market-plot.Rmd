...
This vignette aims to reproduce the published figure(s) of the relationship between the predicted production of **grapes** from a model that 
...
save(countries_risk_market, file = file.path(here::here(), "data", "countries_risk_market.rda"))
}
