...
ca_ava <- readOGR(dsn = "/Volumes/GoogleDrive-104607290079958926089/Shared drives/slfData/data/slfRisk/ava_shapefiles/CA_avas_shapefile", layer = "CA_avas", verbose = F)
or_ava <- readOGR(dsn = "/Volumes/GoogleDrive-104607290079958926089/Shared drives/slfData/data/slfRisk/ava_shapefiles/OR_avas_shapefile", layer = "OR_avas", verbose = F)
wa_ava <- readOGR(dsn = "/Volumes/GoogleDrive-104607290079958926089/Shared drives/slfData/data/slfRisk/ava_shapefiles/WA_avas_shapefile", layer = "WA_avas", verbose = F)
...
temp_points <- read_csv("/Volumes/GoogleDrive-104607290079958926089/Shared drives/slfData/data/slfRisk/scdna_temp/age_time_gridded_data_12888.csv") #the 0.25 degrees spatial extent data
