...
We also tag on a quick piece of code that will calculate the correlations for both versions of the `impact_prod` for the `present` case. We remove `countries` with established *Lycorma* populations.
