...
Quick code to show predicted grape production for both `states` and `countries` together on the same bar chart: This should probably be moved to `vig_041` at some point.
