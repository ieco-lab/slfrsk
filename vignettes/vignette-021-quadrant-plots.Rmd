...
if(present_transport == FALSE){
  ...
  (
    states_plot_final <- states_plot +
      ...
      scale_x_continuous(breaks = c(0,.5,1),labels = c("low", "moderate", "high"), limits = c(0,1.2)) +
      scale_y_continuous(breaks = c(0,.5,1),labels = c("low", "moderate", "high"), limits = c(0,1.2))
  )
...
```{r combined plot, message=FALSE, fig.height= 7.5, fig.width=7.5}
...
if(present_transport){
    ...
    pdf(file.path(here::here(),"vignettes", paste0("combined_future_max_",impact_prod,".pdf")),width = 10, height = 12)
...
grid.arrange(states_grob,legend_country, countries_grob,  nrow = 2, ncol = 2, widths = c(3,1.25), heights = c(5,5))
```
