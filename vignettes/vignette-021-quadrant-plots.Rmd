...
We can report the following alignment of potentials for **`r impact_prod`** as the impact product:

  - U.S. State Alignment Correlation = `r states.impact.cor$estimate` (p = `r states.impact.cor$p.value`)
  - Country Alignment Correlation = `r countries.impact.cor$estimate` (p = `r countries.impact.cor$p.value`)
