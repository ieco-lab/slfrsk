...
-	**MaxEnt**---abbreviation for maximum entropy, a presence-only SDM methodology that uses machine-learning to estimate the probability distribution of maximum entropy based on environmental variables and species occurrence records (@phillips_maximum_2006, @phillips_steven_j._opening_2017).
